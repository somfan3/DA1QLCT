...
public class ThuNhapDAO {
    ...
    public List<ThuNhap> getAllThuNhap() {
        ...
        Cursor cursor = db.rawQuery("select * from "  + TABLE_NAME + " order by " + COLUMN_NGAY_THU ,null);
        cursor.moveToFirst();
    ...
    public void updateLoai(String loaiOld , String loaiNew){
        String sql = "update " + TABLE_NAME + " set " + COLUMN_MA_LOAI_THU + " = '" + loaiNew + "' where " + COLUMN_MA_LOAI_THU + " = '" +loaiOld + "'" ;
        db.execSQL(sql);
    }
}
